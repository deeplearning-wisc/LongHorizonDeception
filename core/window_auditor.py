...
Compared to core/deception_auditor.py (which uses the full history), this
...
Usage examples:
  python core/window_auditor.py --result_name /path/to/session_dir --window 6 --max_parallel 4
  python core/window_auditor.py --result_name Results_checked/GPT5_main/... --window 4
"""
